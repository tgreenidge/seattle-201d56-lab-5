...
function sumArray(sumArr) { //eslint-disable-line
  ...
  return [newSum, output + ' was passed in as an array of numbers, and ' + newSum + ' is their sum.'];
}
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  for (var i = 0; i < multArr.length; i++) {
    newProduct = multiply(multArr[i], newProduct)[0];
    output += multArr[i];
    if (i < multArr.length - 1){
      output += ',';
    }
  }
  return [newProduct, 'The numbers ' + output + ' have a product of ' + newProduct + '.'];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
  ...
  for (var i = 0; i < dynamicArray.length; i++) {
    newProduct = multiply(dynamicArray[i], newProduct)[0];
